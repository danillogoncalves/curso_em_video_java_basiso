 ...
 * @author danil
 */
public class TemaIdiomaSistema extends javax.swing.JFrame {

    /**
     * Creates new form TemaIdiomaSistema
     */
    public TemaIdiomaSistema() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnIdioma.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TemaIdiomaSistema.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TemaIdiomaSistema().setVisible(true);
            }
        });
    }
